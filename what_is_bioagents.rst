...
--------------------
* `bioagentsSchema <https://github.com/bio-agents/bioagentsschema>`_ is a description model for bioinformatics software.  It is a formalised XML schema (XSD) which defines 50 important scientific, technical and administrative attributes.  It defines what attributes may be specified in a *bio.agents* entry, a precise syntax for those descriptions, and controlled vocabularies for consistent description of technical aspects such as software license and software type.
...
* `Curation guidelines <http://bioagents.readthedocs.io/en/latest/curators_guide.html#>`_ describe how each attribute should be specified, *i.e.* concern the quality of an entry. The guidelines go beyond the syntactic and semantic constraints defined by bioagentsSchema and EDAM, and are part of broader `agent information standards <https://github.com/bio-agents/bioagentsSchemaDocs/blob/master/information_requirement.rst>`_ being adopted by *bio.agents*.

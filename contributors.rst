...
.. note:: You can contact the registry-dev group by mailing registry-core@iechor-dk.org 
...
- Anne Wenzel (RTH, DK) - **curation** (RNA agents)
...
- Josep Gelpí (INB / BSC-CSN, ES) - **structural bioinformatics**, benchmarking & agents interoperability
- Juergen Haas (University of Basel, CH) - **protein structural biology**, benchmarking
- Marta Villegas (BSC, ES) - **NLP** and **text mining** 
- Veit Schwämmle (SDU-BMB, DK) - **proteomics**, ontology development, bio.agents applications
...
- Carole Goble (IECHOR-UK)
- Chris Morris (STFC)
- Christian Anthon (University of Copenhagen)
- Christophe Blanchet (IECHOR FR)
...
- Giuseppe Profiti (IECHOR-IT & University of Bologna, IT)
